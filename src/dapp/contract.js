...
export default class Contract {
    ...
    async isOperational() {
        ...
        return await self.flightSuretyApp.methods
            .isOperational()
            .call({from: self.owner, gas:4111111, gasPrice: 100000000000 })
    }
    ...
    async buyInsurance(flight, timestamp, value){
        ...
        return await self.flightSuretyApp.methods
            ...
            .send({from: self.owner, value: value, gas: 4111111, gasPrice: 100000000000 })
    }
    ...
    async registerAirline(flight, wallet){
        ...
        return await self.flightSuretyApp.methods
            ...
            .send({from: self.owner, gas: 4111111, gasPrice: 100000000000 })
    }
